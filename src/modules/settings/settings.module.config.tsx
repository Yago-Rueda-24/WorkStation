...
class SettingsConfig extends BaseFrontendConfig {
    id = 'settings';
    // No definimos 'order' ni 'color', así hereda los valores por defecto (99 y gris)
    title = 'Settings';
...
export const config = new SettingsConfig();
