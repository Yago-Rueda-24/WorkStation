...
const Sidebar: React.FC<SidebarProps> = ({ currentFilter, onFilterChange }) => {
    ...
    return (
        <aside className="w-64 flex-shrink-0 flex flex-col gap-2 relative z-10">
            <div className="bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sticky top-[80px] h-full flex flex-col">
                ...
                <div className="mt-auto pt-6 border-t border-white/10">
                    <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 text-white px-4 py-3 rounded-xl text-sm font-bold shadow-lg shadow-blue-500/25 transition-all duration-300 hover:shadow-blue-500/40 hover:-translate-y-0.5">
